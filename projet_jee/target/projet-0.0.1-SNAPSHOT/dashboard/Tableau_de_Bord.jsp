        ...
        <ul class="items">
            <li class="item">
                <div class="inner">
                    ...
                    <p class="descr">number de Taches</p>
                </div>
            </li>
            <li class="item">
                <div class="inner">
                    ...
                    <p class="descr">number de Taches on hold</p>
                </div>
            </li>
            <li class="item">
                <div class="inner">
                    ...
                    <p class="escr">number de projet</p>
                </div>
            </li>
            <li class="item">
                <div class="inner">
                    ...
                    <p class="descr">number chef de grp</p>
                </div>
            </li>
            <li class="item">
                <div class="inner">
...
<script>
    ...
    var xValues = ["NOUVEAU", "En cours", "Terminé"];
    var yValues = [
